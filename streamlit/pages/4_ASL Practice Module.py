...
def upload_video():
    ...
    if uploaded_file is not None:
        save_directory = "api/I3D_Sign_Language_Classification/videos"
...
def call_fastapi_endpoint(filename, dataset="WLASL2000"):
    ...
    params = {"video": f"api/I3D_Sign_Language_Classification/videos/{filename}",
             "dataset": dataset}
    

    response = requests.get(f"{API_URL}/classify", params=params)
